...
for (CenterInfo ci : CenterInfoAllList) {%>
      ...
      <div id="form1">
         ...
         <div class="d-flex flex-column mb-3">
            <form name="ReservationClassForm">
               <div class="p-2">
                  <label for="inputState">센터 <select class="form-select"
                     id="clctName" name="clctName" onchange="selectcGruop()">
               ...
               <div class="p-2">
                  <label for="inputState">강좌명 <input type="text" id="textCN"
                     name="textCN">
                  </label>
               </div>
   ...
   <script>
    function selectcGruop(){
       console.log(openClassGroupArr);
       console.log(openClasssCNameArr);
